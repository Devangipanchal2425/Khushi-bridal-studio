...
export default function BridalApp() {
      ...
      <div className="min-h-screen w-full bg-black relative flex flex-col justify-between p-6 overflow-hidden animate-fadeIn select-none">
        ...
        <div className="relative z-10 flex justify-between items-center w-full mt-4">
          <button 
            ...
            className="w-12 h-12 rounded-full bg-[#EFA7B3] text-black flex flex-col items-center justify-center space-y-1 shadow-md hover:bg-[#d88c99] transition-all"
          >
        ...
        <div className="relative z-10 my-auto text-left pl-2 max-w-xl space-y-2">
          <div className="space-y-3">
            <div className="w-16 h-[2px] bg-[#EFA7B3]"></div>
            <h2 className="text-[#EFA7B3] text-sm md:text-base font-medium tracking-[0.35em] uppercase font-sans">
              KHUSHI PATEL
            </h2>
          </div>
          ...
          <div className="pt-6">
            <button 
              onClick={() => setShowMainApp(true)}
              className="bg-[#EFA7B3] text-black hover:bg-[#d88c99] font-sans tracking-widest text-xs uppercase px-8 py-3.5 transition-all shadow-lg rounded-sm font-semibold"
            >
              About Me
            </button>
          </div>
        ...
        <div className="relative z-10 flex items-center justify-between w-full mb-4">
          ...
          <a 
            ...
            className="w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all duration-200"
          >
  ...
  // --- 2ND PAGE: MAIN PORTFOLIO & ABOUT ME STUDIO APP ---
  return (
    <div className="min-h-screen bg-white text-[#333333] flex flex-col md:flex-row font-sans selection:bg-[#D46A83] selection:text-white">
      ...
      <aside className="w-full md:w-64 bg-black text-white md:min-h-screen flex flex-col justify-between p-8 flex-shrink-0 z-40">
        <div className="space-y-12">
          {/* Logo Box - Clicking returns to Intro */}
          <div 
            onClick={() => setShowMainApp(false)} 
            className="bg-[#EFA7B3] text-black p-6 text-center shadow-md cursor-pointer hover:bg-[#d88c99] transition-all"
          >
          ...
          <nav className="flex flex-col space-y-5 text-xs font-semibold tracking-[0.25em] uppercase text-left">
            <button 
              onClick={() => setShowMainApp(false)} 
              className="text-gray-400 hover:text-[#EFA7B3] transition-colors text-left"
            >
              HOME
            </button>
            <button 
