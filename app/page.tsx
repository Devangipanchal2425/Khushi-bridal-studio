    ...
    <div className="min-h-screen w-full bg-black relative flex flex-col justify-between p-6 overflow-hidden animate-fadeIn select-none">
      ...
      <div className="relative z-10 my-auto text-left pl-2 max-w-xl space-y-2">
        ...
        <div className="pt-6">
          <Link 
            href="/about"
            className="bg-[#EFA7B3] text-black hover:bg-[#d88c99] font-sans tracking-widest text-xs uppercase px-8 py-3.5 transition-all shadow-lg rounded-sm font-semibold inline-block"
          >
            About Me
          </Link>
        </div>
