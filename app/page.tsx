...
export default function Home() {
  ...
  return (
    <div className="h-[100dvh] w-full bg-black relative flex flex-col justify-between p-4 sm:p-6 md:p-8 overflow-hidden select-none">
      {/* Background Image */}
      <div 
      ...
      {/* Top Header Row - Top Left Menu Button */}
      <div className="relative z-10 flex justify-start items-center w-full pt-2">
        <Link 
          href="/about"
      ...
      {/* Central Content */}
      <div className="relative z-10 my-auto text-left pl-2 sm:pl-4 w-full max-w-xl space-y-3 py-8">
        ...
        <h1 className="text-white font-serif text-3xl sm:text-5xl md:text-6xl tracking-wide uppercase font-light leading-tight pt-1">
          MAKEUP ARTIST
        </h1>
