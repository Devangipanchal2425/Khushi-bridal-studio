...
export default function Home() {
  ...
  const logoImageUrl = "/studio-logo.jpeg";
  ...
  return (
    <div className="min-h-screen w-full bg-black relative flex flex-col justify-between p-4 sm:p-6 overflow-x-hidden animate-fadeIn select-none">
      ...
      {/* Top Header Row with Logo & Menu Button */}
      <div className="relative z-10 flex justify-between items-center w-full mt-2 sm:mt-4">
        {/* Khushi Makeover Logo */}
        <div className="bg-[#EFA7B3] p-2 rounded-lg flex items-center justify-center shadow-md">
          <img 
            src={logoImageUrl} 
            alt="Khushi Makeover Logo" 
            className="h-9 sm:h-12 w-auto object-contain rounded-sm"
          />
        </div>
      ...
      <div className="relative z-10 my-auto text-left pl-2 max-w-xl space-y-2 py-8">
        <div className="space-y-3">
          <div className="w-12 sm:w-16 h-[2px] bg-[#EFA7B3]"></div>
          <h2 className="text-[#EFA7B3] text-xs sm:text-sm md:text-base font-medium tracking-[0.3em] uppercase font-sans">
            KHUSHI PATEL
          </h2>
        </div>
      ...
      <div className="relative z-10 flex items-center justify-between w-full mb-2 sm:mb-4">
        ...
        <a 
          ...
          className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all duration-200"
        >
          <svg className="w-7 h-7 sm:w-8 sm:h-8 fill-white" viewBox="0 0 32 32">
