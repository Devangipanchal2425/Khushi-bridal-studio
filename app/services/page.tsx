...
// ----------------------------------------------------
// Khushi's Personal Beauty Advisor Component Code
// ----------------------------------------------------
function SmartPackageFinder() {
  ...
  return (
    <section className="bg-gradient-to-br from-pink-50 via-white to-gray-50 p-6 md:p-10 rounded-2xl border border-pink-200 my-10 shadow-sm relative overflow-hidden">
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-pink-200/40 rounded-full blur-2xl pointer-events-none"></div>

      <div className="text-center max-w-2xl mx-auto mb-8 relative z-10">
        <span className="bg-pink-100 text-[#d8586c] font-bold text-[11px] px-3.5 py-1.5 rounded-full tracking-widest uppercase shadow-xs inline-block">
          💖 KHUSHI’S PERSONAL BEAUTY ADVISOR
        </span>
        <h2 className="text-2xl md:text-3xl font-serif font-bold text-gray-900 mt-3">
          FIND YOUR DREAM BEAUTY LOOK
        </h2>
        <p className="text-xs text-gray-600 mt-2 italic">
          “Confused about what to book? Tell me your occasion, skin type & budget — and I'll suggest the perfect package for your glow! ✨”
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 relative z-10">
        {/* Step 1 */}
        <div className="bg-white p-5 rounded-xl border border-pink-100 shadow-2xs">
            ...
            {[
              ...
              <button
                ...
                className={`w-full text-left text-xs p-3 rounded-lg transition-all border ${
                  occasion === item.id
                    ? "bg-[#f3a0ad] text-black font-bold border-[#f3a0ad] shadow-xs"
                    : "bg-gray-50 text-gray-700 border-gray-200 hover:bg-pink-50/50"
                }`}
              >
                {item.label}
              </button>
      ...
      {recommendation ? (
        <div className="bg-white border-2 border-[#f3a0ad] p-6 md:p-8 rounded-xl shadow-md max-w-2xl mx-auto transition-all relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-pink-100 pb-4 mb-4">
            <div>
              <span className="bg-pink-100 text-[#d8586c] text-[10px] font-bold px-2.5 py-1 rounded-full uppercase">
                ✨ KHUSHI'S SPECIAL PICK
              </span>
          ...
          <div className="bg-pink-50 text-[11px] text-pink-900 p-3 rounded-lg mb-6 font-medium border border-pink-100">
            {recommendation.tip}
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full inline-flex items-center justify-center bg-[#25D366] hover:bg-[#1eb856] text-white py-3.5 px-6 text-xs font-bold tracking-wider rounded-lg transition-all shadow-xs"
          >
        ...
        <div className="text-center p-6 bg-white/80 border border-dashed border-pink-200 rounded-xl max-w-md mx-auto text-gray-400 text-xs font-medium relative z-10">
          👉 Please select options above to see Khushi's package recommendation.
        </div>
      )}
    </section>
  );
