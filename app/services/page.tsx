      ...
      {recommendation ? (
        <div className="bg-white border-2 border-[#f3a0ad] p-6 rounded-xl shadow-md transition-all relative z-10">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full inline-flex items-center justify-center bg-[#25D366] hover:bg-[#1eb856] text-white py-3 px-5 text-xs font-bold tracking-wider rounded-lg transition-all shadow-xs"
          >
