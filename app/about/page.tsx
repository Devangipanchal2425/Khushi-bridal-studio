...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[100dvh] h-auto md:h-screen w-full bg-white select-none overflow-x-hidden md:overflow-hidden">
      
      {/* 1. LEFT SIDEBAR - Responsive Width on Mobile & Fixed on Desktop */}
      <aside className="w-full md:w-[260px] lg:w-[280px] bg-black text-white flex flex-col justify-between p-5 md:p-8 shrink-0 md:h-full z-20">
        
        {/* Top Branding Box */}
        <div className="bg-[#EFA7B3] text-black p-4 md:p-5 text-center shadow-sm rounded-sm">
          <h1 className="font-serif text-2xl md:text-3xl font-bold tracking-widest leading-none">KP</h1>
          <h2 className="text-[11px] md:text-xs font-semibold tracking-[0.2em] uppercase mt-2">KHUSHI PATEL</h2>
          <p className="text-[8px] md:text-[9px] tracking-widest uppercase font-medium mt-0.5 text-black/70">MAKE-UP ARTIST</p>
        </div>

        {/* Navigation Links */}
        <nav className="flex flex-col space-y-4 md:space-y-5 my-6 md:my-auto text-[11px] md:text-xs tracking-[0.25em] font-medium uppercase">
      ...
      <main className="flex-1 bg-white p-5 sm:p-8 md:p-12 lg:p-16 overflow-y-auto h-full text-gray-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-5 md:space-y-6">
            ...
            <div className="flex justify-between items-start pt-1">
              <div>
                <p className="text-[#EFA7B3] text-[11px] md:text-sm tracking-[0.3em] font-medium uppercase">
                  KHUSHI PATEL
                </p>
                <h1 className="text-black font-serif text-2xl sm:text-4xl lg:text-5xl tracking-tight uppercase mt-1 font-normal leading-tight">
                  MAKEUP ARTIST
                </h1>
                <div className="w-12 h-[2px] bg-[#EFA7B3] mt-2 sm:mt-3"></div>
              </div>
            ...
            {/* Paragraphs */}
            <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm text-gray-600 font-sans leading-relaxed pt-1">
              <p>
            ...
            <div className="pt-4 md:pt-6">
              <h3 className="text-[#EFA7B3] text-[10px] sm:text-[11px] tracking-[0.25em] font-medium uppercase mb-3 sm:mb-4">
                HIGHLIGHTS & SPECIALTIES
              </h3>

              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
                {/* Card 1 */}
                <div className="border border-gray-100 rounded-sm p-3 sm:p-4 text-center bg-gray-50/50 hover:border-gray-200 transition-all">
                  <div className="text-base sm:text-lg mb-1 sm:mb-2">✨</div>
                  <h4 className="text-[10px] sm:text-[11px] font-serif font-bold text-black tracking-wider uppercase leading-tight">LUXURY BRIDAL</h4>
                  <p className="text-[8px] sm:text-[9px] text-gray-400 uppercase tracking-widest mt-1">COUTURE LOOKS</p>
                </div>

                {/* Card 2 */}
                <div className="border border-gray-100 rounded-sm p-3 sm:p-4 text-center bg-gray-50/50 hover:border-gray-200 transition-all">
                  <div className="text-base sm:text-lg mb-1 sm:mb-2">👑</div>
                  <h4 className="text-[10px] sm:text-[11px] font-serif font-bold text-black tracking-wider uppercase leading-tight">ULTRA HD SKIN</h4>
                  <p className="text-[8px] sm:text-[9px] text-gray-400 uppercase tracking-widest mt-1">CAMERA READY</p>
                </div>

                {/* Card 3 */}
                <div className="border border-gray-100 rounded-sm p-3 sm:p-4 text-center bg-gray-50/50 hover:border-gray-200 transition-all">
                  <div className="text-base sm:text-lg mb-1 sm:mb-2">💎</div>
                  <h4 className="text-[10px] sm:text-[11px] font-serif font-bold text-black tracking-wider uppercase leading-tight">PREMIUM PRODUCTS</h4>
                  <p className="text-[8px] sm:text-[9px] text-gray-400 uppercase tracking-widest mt-1">GLOBAL BRANDS</p>
                </div>

                {/* Card 4 */}
                <div className="border border-gray-100 rounded-sm p-3 sm:p-4 text-center bg-gray-50/50 hover:border-gray-200 transition-all">
                  <div className="text-base sm:text-lg mb-1 sm:mb-2">🕊️</div>
                  <h4 className="text-[10px] sm:text-[11px] font-serif font-bold text-black tracking-wider uppercase leading-tight">CUSTOM GLAM</h4>
                  <p className="text-[8px] sm:text-[9px] text-gray-400 uppercase tracking-widest mt-1">TAILORED BEAUTY</p>
                </div>
              </div>
            </div>
      ...
      <a 
        ...
        className="fixed bottom-5 right-5 z-50 w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl hover:scale-105 active:scale-95 transition-all"
      >
        <svg className="w-5 h-5 sm:w-8 sm:h-8 fill-white" viewBox="0 0 32 32">
